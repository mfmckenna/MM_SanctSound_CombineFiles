...
# also plots comparsions for 2020 vs 2021
...
library(gridExtra)
#-----------------------------------------------------------------------------------------
inDir  = "H:\\RESEARCH\\SanctSound\\data2\\combineFiles2_Abiotic"
outDir = "H:\\RESEARCH\\SanctSound\\data2\\combineFiles3_Detections"
...
#Daily files
inDay = list.files( "H:\\RESEARCH\\SanctSound\\data2\\combineFiles1_SPLShips","_Day_",full.names = T)
ifile = inDay[22]
...
#-----------------------------------------------------------------------------------------
dir2  = paste0("H:\\RESEARCH\\SanctSound\\data\\",sanct,"\\",site)

#atlanticcod-- start and end times, need to convert to daily detections
#-----------------------------------------------------------------------------------------
